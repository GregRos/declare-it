...
declare class Expecting𝗧𝗬𝗣𝗘<TestText, Subject> {
    ...
    to_strictly_subtype<Reference>(): Compute_ToSubtype<
        ...
        TestText
    > extends 1
        ? Compute_ToResemble<Subject, Reference, "🔴 FAIL", TestText>
        : Compute_ToSubtype<Subject, Reference, TestText, "🔴 FAIL">
    ...
    > extends 1
        ? Compute_ToResemble<Subject, Reference, "🔴 FAIL", TestText>
        : Compute_ToSupertype<Subject, Reference, TestText, "🔴 FAIL">
}
