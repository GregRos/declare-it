...
export type Compute_Resembles<L, R, T, F> =
    IsAny<L> extends 1
        ? IsAny<R> extends 1
            ? 𝗔𝗦𝗦𝗘𝗥𝗧_𝗥𝗘𝗦𝗘𝗠𝗕𝗟𝗘𝗦<L, Texts["are_both_any"], R> | T
            : 𝗔𝗦𝗦𝗘𝗥𝗧_𝗥𝗘𝗦𝗘𝗠𝗕𝗟𝗘𝗦<L, Texts["is_any_but_not"], R> | F
        : IsAny<R> extends 1
          ? 𝗔𝗦𝗦𝗘𝗥𝗧_𝗥𝗘𝗦𝗘𝗠𝗕𝗟𝗘𝗦<L, Texts["is_not_any_but"], R> | F
          : [L] extends [R]
            ? [R] extends [L]
...
export type Compute_Equals<L, R, T, F> =
    IsAny<L> extends 1
        ? IsAny<R> extends 1
            ? 𝗔𝗥𝗘_𝗡𝗢𝗧_𝗘𝗤𝗨𝗔𝗟<L, Texts["are_both_any"], R> & F
            : 𝗔𝗥𝗘_𝗡𝗢𝗧_𝗘𝗤𝗨𝗔𝗟<L, Texts["is_any_but_not"], R> & F
        : IsAny<R> extends 1
          ? 𝗔𝗥𝗘_𝗡𝗢𝗧_𝗘𝗤𝗨𝗔𝗟<L, Texts["is_not_any_but"], R> & F
          : [L] extends [R]
            ? [R] extends [L]
